...
from bot.keyboards import get_phone_keyboard, get_visa_keyboard, get_main_keyboard
from bot.translations import get_text
from database import save_user_phone, save_user, save_user_visa, get_user_language, get_user, save_user_name
...
async def process_visa(message: Message, state: FSMContext):
    ...
    valid_visas = ['B/1', 'B/2', 'A/5', 'A/2', 'Другое', 'Other']
    ...
    # Уведомляем админов о новом кандидате
    await notify_admins(
        tg_id=tg_id,
        name=name,
        phone=phone,
