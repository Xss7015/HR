TRANSLATIONS = {
    'russian': {
        ...
        'admin_add_visa': '✏️ Введите тип визы (B/1, B/2, A/5, A/2, Other):',
    ...
    'english': {
        ...
        'admin_add_visa': '✏️ Enter visa type (B/1, B/2, A/5, A/2, Other):',
    ...
    'hebrew': {
        ...
        'admin_add_visa': '✏️ הזן סוג ויזה (B/1, B/2, A/5, A/2, Other):',
